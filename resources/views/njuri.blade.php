  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Penilaian Juri</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="{{url('/admin')}}">Kembali</a></li>
              <li class="breadcrumb-item active">Penilaian Juri</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
...
<thead>
<tr><th><center>Nama Kelompok</center></th><th><center>ID Juri</center></th><th><center>Kriteria 1</center></th><th><center>Kriteria 2</center></th>
