	...
	<div class="modal-dialog modal-xl">
       ...
       <div class="card">
              <div class="card-body">
                ...
                <script src="{{asset('https://ajax.googleapis.com/ajax/libs/jquery/1.8.2/jquery.min.js')}}" type="text/javascript"></script>
<script>
        $(document).ready(function() {
           
            $('#k4').keyup(function(ev) {
              var total1 = $('#k1').val() * 1;
                var tot_price1 = (total1 * 0.25);
                var total2 = $('#k2').val() * 1;
                var tot_price2 = (total2 * 0.25);
                var total3 = $('#k3').val() * 1;
                var tot_price3 = (total3 * 0.25);
                var total4 = $('#k4').val() * 1;
                var tot_price4 =tot_price1+tot_price2+tot_price3+(total4 * 0.25);
                var divobj = document.getElementById('tot');
                divobj.value = tot_price4;
            });
        });
    </script>
		           <label> Kriteria 1 :  </label> <input type="number" required="required" name="k1" class="form-control" id="k1"> <br/>
               <label> Kriteria 2 :  </label> <input type="number" required="required" name="k2" class="form-control" id="k2"> <br/>
		           <label> Kriteria 3 :  </label> <input type="number" required="required" name="k3" class="form-control" id="k3"> <br/>
               <label> Kriteria 4 :  </label> <input type="number" required="required" name="k4" class="form-control" id="k4"> <br/>
               <label> Total :  </label> <input type="number" required="required" name="tot" id="tot" class="form-control" readonly> <br/>
