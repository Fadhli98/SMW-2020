...
<div class="wrapper">
  ...
  <h2>Penilaian Film</h2>
  </div>
  <div class="card-body">
  <table id="example2" class="table table-bordered table-hover">
<thead>
<tr><th><center>Nama Kelompok</center></th><th><center>ID Juri</center></th><th><center>Kriteria 1 (25%)</center></th><th><center>Kriteria 2 (25%)</center></th>
<th><center>Kriteria 3 (25%)</center></th><th><center>Kriteria 4 (25%)</center></th><th><center>Total</center></th><th><center>Aksi</center></th>
</tr>
</thead>
<tbody>
</tbody>
@foreach($nilai as $n)
    ...
    <td>{{ $n->id_juri }}</td>
      ...
      <td>{{ $n->kriteria4 }}</td>
      <td>{{ $n->nilai_hasil }}</td>
      <td><a href="{{url('/editnilai/'.$n->id_nilai)}}">Edit nilai</a></td>
		</tr>
		@endforeach
</table>
</div>
